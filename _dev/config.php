<?php
    ...
    //define( 'K_SITE_URL', 'http://www.divorceandwellbeing.com/' );
    ...
    define( 'K_DB_NAME', 'dandw' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'dandw' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'Dcfvg123*' );
    // 7.
    // MySQL hostname (it will usually be 'localhost')
    define( 'K_DB_HOST', 'amwebitcouk.ipagemysql.com' );
    // 7b.
    ...
    define( 'K_EMAIL_TO', 'info@divorceandwellbeing.co.uk' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'info@divorceandwellbeing.co.uk' );
